  ...
  return (
    ...
    >
      ...
      <div className='z-20 flex flex-col items-start'>
        ...
        <p className='text-[#9CA4AB] font-normal text-[16px] leading-[22px] flex gap-1 items-center mt-2'>
          <span>2h 40m</span>. <span>2022</span>.<span>Fantasy</span>.<span>Action</span>
        </p>
        <p className='font-normal text-white text-[17px] leading-6 tracking-wider mt-2 w-[600px]'>
